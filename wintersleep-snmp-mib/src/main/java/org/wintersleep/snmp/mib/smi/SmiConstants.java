...
public class SmiConstants {
    ...
    public static final SmiMib WINTERSLEEP_SNMP_BUILTIN_MIB = new SmiMib(new SmiOptions(), null);
    public static final SmiModule WINTERSLEEP_SNMP_BUILTIN_MODULE = new SmiModule(WINTERSLEEP_SNMP_BUILTIN_MIB, new IdToken(null, "WINTERSLEEP_SNMP_BUILTIN_MIB"));
...
//            ""
    ...
    public  static final Location LOCATION = new Location("WINTERSLEEP_SNMP_BUILTIN_MIB");

    private static SmiType newType(String id, SmiPrimitiveType primitiveType) {
        return new SmiType(new IdToken(LOCATION, id), WINTERSLEEP_SNMP_BUILTIN_MODULE, primitiveType);
    }
