...
header {
package org.wintersleep.snmp.mib.phase.file.antlr;

import org.wintersleep.snmp.util.token.*;
import org.wintersleep.snmp.mib.smi.*;
import org.wintersleep.snmp.mib.phase.file.*;
...
{
	org.wintersleep.snmp.util.token.Token rv1 = null;
	org.wintersleep.snmp.util.token.Token rv2 = null;
}
:
	rv1=range_value
...
range_value returns [org.wintersleep.snmp.util.token.Token t = null]
:
	t=big_integer_token
